...
def _get_filenames_and_classes(raw_data_dir):
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'dandy_%s_%05d-of-%05d.tfrecord' % (
...
def run(raw_data_dir, dataset_dir):
...
#   dataset_utils.download_and_uncompress_tarball(_DATA_URL, dataset_dir)
  photo_filenames, class_names = _get_filenames_and_classes(raw_data_dir)
